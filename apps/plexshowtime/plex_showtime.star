...
load("http.star", "http")
load("images/plex_banner.jpg", PLEX_BANNER_ASSET = "file")
load("images/plex_banner_portrait.jpg", PLEX_BANNER_PORTRAIT_ASSET = "file")
load("images/plex_icon.jpg", PLEX_ICON_ASSET = "file")
