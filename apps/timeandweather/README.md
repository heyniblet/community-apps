...
**Configuration or behavior difference:** The current schema fixes the provider to Open-Meteo. Older provider settings are no longer exposed, although some legacy code remains.
