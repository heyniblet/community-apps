...
**Configuration or behavior difference:** The manifest ID changed to `dolar-blue`. Existing installations may require an identity mapping before replacing the app.
