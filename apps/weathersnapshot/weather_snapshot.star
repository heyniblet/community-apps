...
load("images/humid_icon_dee95435.png", HUMID_ICON_dee95435_ASSET = "file")
load("images/orange_cloud_icon_a3e7cd50.png", ORANGE_CLOUD_ICON_a3e7cd50_ASSET = "file")
load("images/rain_icon_cee23e18.png", RAIN_ICON_cee23e18_ASSET = "file")
load("images/red_cloud_icon_fe1bdfd7.png", RED_CLOUD_ICON_fe1bdfd7_ASSET = "file")
load("images/snow_icon_4f788041.png", SNOW_ICON_4f788041_ASSET = "file")
load("images/sun_icon_f5cf8e5d.png", SUN_ICON_f5cf8e5d_ASSET = "file")
load("images/sun_with_clouds_icon_f5cf8e5d.png", SUN_WITH_CLOUDS_ICON_f5cf8e5d_ASSET = "file")
load("images/super_humid_icon_6544bb42.png", SUPER_HUMID_ICON_6544bb42_ASSET = "file")
...
SUN_ICON = SUN_ICON_f5cf8e5d_ASSET.readall()
SUN_WITH_CLOUDS_ICON = SUN_WITH_CLOUDS_ICON_f5cf8e5d_ASSET.readall()
CLOUDS_ICON = CLOUDS_ICON_36301c5e_ASSET.readall()
GRAY_CLOUDS_ICON = GRAY_CLOUDS_ICON_eec691a1_ASSET.readall()
RAIN_ICON = RAIN_ICON_cee23e18_ASSET.readall()
THUNDER_ICON = THUNDER_ICON_ce9654d1_ASSET.readall()
SNOW_ICON = SNOW_ICON_4f788041_ASSET.readall()
HUMID_ICON = HUMID_ICON_dee95435_ASSET.readall()
VERY_HUMID_ICON = VERY_HUMID_ICON_82b551d5_ASSET.readall()
SUPER_HUMID_ICON = SUPER_HUMID_ICON_6544bb42_ASSET.readall()
GREEN_CLOUD_ICON = GREEN_CLOUD_ICON_45a029c4_ASSET.readall()
YELLOW_CLOUD_ICON = YELLOW_CLOUD_ICON_ddf87ffa_ASSET.readall()
ORANGE_CLOUD_ICON = ORANGE_CLOUD_ICON_a3e7cd50_ASSET.readall()
RED_CLOUD_ICON = RED_CLOUD_ICON_fe1bdfd7_ASSET.readall()
...
def main(config):
    ...
    #update api key and cache value if a personal api key is provided
    api_key = config.get("api_key", "")
    freq_update = True

    if api_key in (None, ""):
        print("API key not provided, using static data instead")
    ...
    return schema.Schema(
        ...
        fields = [
            schema.Text(
                id = "api_key",
                name = "API Key",
                desc = "(Optional) Free v2.5 OpenWeather API Key. If provided, offers more frequent weather updates.",
                icon = "key",
                secret = True,
            ),
            schema.Location(
