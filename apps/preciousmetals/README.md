...
# Precious Metals for Tidbyt

Displays current Gold, Silver, and Platinum prices in USD per troy ounce from the documented, keyless [Gold API](https://gold-api.com/docs).
