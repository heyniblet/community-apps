"""
Applet: NCAAW Scores
Summary: Displays NCAA Womens Basketball scores
...
teamOptions = [
    ...
    schema.Option(
        display = "Alabama State Lady Hornets",
        value = "2011",
    ),
    schema.Option(
    ...
    schema.Option(
        display = "Alcorn State Lady Braves",
        value = "2016",
    ),
    schema.Option(
    ...
    schema.Option(
        display = "Delaware State Lady Hornets",
        value = "2169",
    ),
    schema.Option(
    ...
    schema.Option(
        display = "East Tennessee State Bucs",
        value = "2193",
    ),
    schema.Option(
    ...
    schema.Option(
        display = "Hawai'i Rainbow Wahine",
        value = "62",
    ),
    schema.Option(
    ...
    schema.Option(
        display = "Jackson State Lady Tigers",
        value = "2296",
    ),
    schema.Option(
    ...
    schema.Option(
        display = "Louisiana Tech Lady Techsters",
        value = "2348",
    ),
    schema.Option(
    ...
    schema.Option(
        display = "Maryland-Eastern Shore Lady Hawks",
        value = "2379",
    ),
    schema.Option(
        display = "McNeese Cowgirls",
        value = "2377",
    ),
    schema.Option(
    ...
    schema.Option(
        display = "Middle Tennessee Lady Raiders",
        value = "2393",
    ),
    schema.Option(
    ...
    schema.Option(
        display = "Mississippi Valley State Devilettes",
        value = "2400",
    ),
    schema.Option(
        display = "Missouri State Lady Bears",
        value = "2623",
    ),
    schema.Option(
    ...
    schema.Option(
        display = "Morgan State Lady Bears",
        value = "2415",
    ),
    schema.Option(
    ...
    schema.Option(
        display = "Northwestern State Lady Demons",
        value = "2466",
    ),
    schema.Option(
    ...
    schema.Option(
        display = "Oklahoma State Cowgirls",
        value = "197",
    ),
    schema.Option(
    ...
    schema.Option(
        display = "Prairie View A&M Lady Panthers",
        value = "2504",
    ),
    schema.Option(
    ...
    schema.Option(
        display = "Queens University Royals",
        value = "2511",
    ),
    schema.Option(
    ...
    schema.Option(
        display = "SE Louisiana Lady Lions",
        value = "2545",
    ),
    schema.Option(
    ...
    schema.Option(
        display = "South Carolina State Lady Bulldogs",
        value = "2569",
    ),
    schema.Option(
    ...
    schema.Option(
        display = "Southern Indiana Screaming Eagles",
        value = "88",
    ),
    schema.Option(
    ...
    schema.Option(
        display = "Stephen F. Austin Ladyjacks",
        value = "2617",
    ),
    schema.Option(
    ...
    schema.Option(
        display = "Tennessee Lady Volunteers",
        value = "2633",
    ),
    schema.Option(
        display = "Tennessee State Lady Tigers",
        value = "2634",
    ),
    schema.Option(
    ...
    schema.Option(
        display = "Texas Tech Lady Raiders",
        value = "2641",
    ),
    schema.Option(
    ...
    schema.Option(
        display = "Western Kentucky Lady Toppers",
        value = "98",
    ),
    schema.Option(
