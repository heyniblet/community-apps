...
"""
Applet: UFL Scores
Summary: Displays UFL scores
Description: Displays live and upcoming UFL scores from a data feed.
Author: LunchBox8484
"""
...
ALT_LOGO = """
{
    "BIR" : "https://res.cloudinary.com/xfl-production/image/upload/c_fill,w_48/q_auto/f_auto/v1/ufl-prod/Team%20Logos/linkstrips/linkstrip-birm-first",
    "MEM" : "https://res.cloudinary.com/xfl-production/image/upload/c_fill,w_48/q_auto/f_auto/v1/ufl-prod/Team%20Logos/linkstrips/new/MEM_Icon",
    "MIC" : "https://res.cloudinary.com/xfl-production/image/upload/c_fill,w_48/q_auto/f_auto/v1/ufl-prod/Team%20Logos/linkstrips/new/MI_Icon",
    "SA" : "https://res.cloudinary.com/xfl-production/image/upload/c_fill,w_48/q_auto/f_auto/v1/ufl-prod/Team%20Logos/linkstrips/new/SA_Icon"
}
"""
MAGNIFY_LOGO = """
{
...
def main(config):
    ...
    datePast = calendar_day - time.parse_duration("%dh" % (1 * 24))
    dateFuture = calendar_day + time.parse_duration("%dh" % (30 * 24))
...
teamOptions = [
    ...
    schema.Option(
        display = "Memphis Showboats",
        value = "129043",
    ),
    schema.Option(
        display = "Michigan Panthers",
        value = "125957",
    ),
    schema.Option(
