...
Description: Show daily, weekly, monthly and/or yearly sales numbers.
Author: Shopify
"""
    ...
    return render.Root(
        child = render.Stack(
            children = [
                ...
                animation.Transformation(
                    child = render_sales_for_period(daily, "daily"),
                    duration = 0,
                    delay = 0,
                    keyframes = [
                        animation.Keyframe(
                ...
                animation.Transformation(
                    child = render_sales_for_period(weekly, "weekly"),
                    duration = 0,
                    delay = 75,
                    keyframes = [
                        animation.Keyframe(
                ...
                animation.Transformation(
                    child = render_sales_for_period(monthly, "monthly"),
                    duration = 0,
                    delay = 150,
                    keyframes = [
                        animation.Keyframe(
                ...
                animation.Transformation(
                    child = render_sales_for_period(yearly, "yearly"),
                    duration = 0,
                    delay = 225,
                    keyframes = [
                        animation.Keyframe(
...
def render_sales_for_period(sales, period):
...
def render_content(sales, color):
    return render.Box(
        width = 64,
        padding = 3,
        color = COLOR_KALE,
