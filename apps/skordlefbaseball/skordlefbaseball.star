"""
Applet: SkordleFBaseball
Summary: Displays Baseball Games
Description: The app gets Fall baseball data from the Skordle website to diplay on the Tidbyt. Users can choose the class and game to display.
        ...
        return render.Root(
            child = render.Box(
                child = render.WrappedText(
                    content = "No Events for Fall Baseball {}".format(sportClass),
                    width = 60,
                    linespacing = 1,
                    font = "CG-pixel-3x5-mono",
                ),
...
def get_data(classID):
    web = http.get("https://skordle.com/scores/?sportid=12&classid={}&clubid=1".format(classID), ttl_seconds = 60)
    ...
    return schema.Schema(
        ...
        fields = [
            schema.Dropdown(
                id = "class",
                name = "Classes",
                desc = "The class of football whose games will be displayed",
