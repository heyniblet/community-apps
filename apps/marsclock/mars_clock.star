...
load("images/earth_icon.png", EARTH_ICON_ASSET = "file")
load("images/heart_icon.png", HEART_ICON_ASSET = "file")
load("images/mars_icon.png", MARS_ICON_ASSET = "file")
load("math.star", "math")
load("render.star", "render")
load("schema.star", "schema")
load("time.star", "time")

EARTH_ICON = EARTH_ICON_ASSET.readall()
HEART_ICON = HEART_ICON_ASSET.readall()
MARS_ICON = MARS_ICON_ASSET.readall()
